...
class Utils {
    ...
    protected static String persianString(String number) {
        number = number.trim();
        String persianNum = "";
    ...
    protected static String englishString(String number) {
        number = number.trim();
        String persianNum = "";
        for (int i = 0; i < number.length(); i++) {
            switch (number.substring(i, i + 1)) {
    ...
    protected static String trimzero(String number) {
    ...
    protected static String getNumber(String string){
        String number="";
    ...
    protected static String separate3(String sNum) {
